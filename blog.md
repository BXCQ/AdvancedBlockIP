...
**v2.3.2 (2025-07-11)**
- 修复：修复了因插件首次激活、配置尚未存在时，访问网站前台会导致程序崩溃的问题。通过改进异常捕获机制，确保在任何情况下都能优雅地处理配置缺失，避免了致命错误。

**v2.3.1 (2025-07-10)**
- 修复：修复了在IP防护控制台删除黑名单条目后，列表格式会因换行符处理不当而错乱的问题。
- 修复：修复了禁用再启用插件后，已保存的黑名单和白名单配置无法在设置页面正常显示的问题。
